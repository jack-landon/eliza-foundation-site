          ...
          {isMobile ? (
            <>
              <ProjectCardVertical
                ...
                imgSrc="/project-images/project-01-img.png"
                variant="dark"
              />
              <ProjectCardVertical
                ...
                imgSrc="/project-images/project-02-img.png"
                variant="dark"
              />
              <ProjectCardVertical
                ...
                imgSrc="/project-images/project-03-img.png"
                variant="dark"
              />
              <ProjectCardVertical
                ...
                imgSrc="/project-images/project-04-img.png"
                variant="dark"
              />
            </>
          ) : (
